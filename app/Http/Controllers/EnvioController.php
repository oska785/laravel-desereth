    ...
    public function store(Request $request)
    {
        $request->validate(
            ...
            [
                ...
                "dni_del_remitente.required" => "El campo C I del remitente es obligatorio",
                "dni_del_remitente.regex" => "Este campo solo permite 7  digitos",
                ...
                "dni_del_consignatario.required" => "El campo C I del consignatario es obligatorio",
                "dni_del_consignatario.regex" => "Este campo solo permite 7 digitos",
