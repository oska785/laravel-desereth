...
class UsuarioController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $verificarDuplicado = DB::select("select count(*) as 'total' from usuario where usuario='$usuario' or nombres='$nombre' ");
        if ($verificarDuplicado[0]->total >= 1) {
            return back()->with("INCORRECTO", "El Usuario o Nombre ya existe");
        }
