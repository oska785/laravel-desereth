                ...
                <div class="modal-body">
                    <form action="{{ route('remitente.store') }}" method="POST">
                        ...
                        <div class="fl-flex-label mb-4 px-2 col-12">
                            <input required type="number" placeholder="CI / NIT" class="input input__text" name="dni"
                                value="{{ old('dni') }}">
                            @error('dni')
                        ...
                        <div class="fl-flex-label mb-4 px-2 col-12">
                            <input required type="text" placeholder="Nombre o Razon Social" class="input input__text"
                                name="nombre" value="{{ old('nombre') }}"style="text-transform: uppercase;" oninput="this.value = this.value.toUpperCase()">
                            @error('nombre')
                                <span class="text-danger font-weight-bold">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="fl-flex-label mb-4 px-2 col-12">
                            <input type="text" placeholder="Dirección" class="input input__text" name="direccion"
                                value="{{ old('direccion') }}"style="text-transform: uppercase;" oninput="this.value = this.value.toUpperCase()">
                        </div>
                        <div class="fl-flex-label mb-4 px-2 col-12">
                            <input type="number" placeholder="Teléfono" class="input input__text" name="telefono"
                                value="{{ old('telefono') }}">
                        </div>
