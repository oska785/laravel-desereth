                    ...
                    <form action="{{ route('sucursal.store') }}" method="POST">
                        ...
                        <div class="fl-flex-label mb-4 px-2 col-12">
                            <input required type="text" placeholder="Nombre" class="input input__text" name="nombre"
                                value="{{ old('nombre') }}"style="text-transform: uppercase;" oninput="this.value = this.value.toUpperCase()">
                        </div>
                        ...
                        <div class="fl-flex-label mb-4 px-2 col-12">
                            <input required type="text" placeholder="Dirección" class="input input__text"
                                name="direccion" value="{{ old('direccion') }}"style="text-transform: uppercase;" oninput="this.value = this.value.toUpperCase()">
                        </div>

                        <div class="fl-flex-label mb-4 px-2 col-12">
                            <input required type="number" placeholder="Teléfono" class="input input__text" name="telefono"
                                value="{{ old('telefono') }}">
                        </div>
