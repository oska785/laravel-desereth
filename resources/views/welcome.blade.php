    ...
    <style>
        * {
        ...
        .fondo {
            width: 100%;
            height: 100vh;
            background-image: url("{{ asset('img-inicio/303.jpg') }}");
...
<body class="antialiased">
    <div class="fondo">
        <div class="container">
            <a class="login" href="{{ route('home') }}">INICIAR SESION</a>
            @foreach ($empresa as $item)
                <h1>TRANSPORTES LOGISTICA DESERETH</h1>
            @endforeach
            <form action="{{ route('buscar.buscarEnvioCliente') }}" method="get">
                <div class="form">
                    <p>Ingrese su Número de Guia</p>
                    <input required id="numero" autofocus type="number" name="numero"
                        placeholder="Número de ticket / Guia">
                    @error('numero')
                        <p class="error">Ingrese su Número de Ticket / Guia</p>
                    @enderror
