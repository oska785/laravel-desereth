                    ...
                    <form action="{{ route('usuario.create') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="fl-flex-label mb-4 px-2 col-12">
                            <input required type="text" placeholder="Nombre" class="input input__text" name="txtnombre"
                                value="{{ old('txtnombre') }}"style="text-transform: uppercase;" oninput="this.value = this.value.toUpperCase()">
                        </div>
                        ...
                        <div class="fl-flex-label mb-4 px-2 col-12">
                            <input required type="number" placeholder="Teléfono" class="input input__text"
