    ...
    @foreach ($datos as $datos)
        <div class="ticket">
            @foreach ($empresa as $item)
                <h1>{{ $item->nombre }}</h1>
                <a class="numero">NRO DE GUIA :{{$datos->numero_reg }}</a>
                <hr>
                {{--<h2>DATOS DE LA EMPRESA</h2>--}}
                <p><strong>Direccion:</strong> {{ $item->ubicacion }}</p>
            ...
            <hr>
            <h2>REMITENTE</h2>
            <p><strong>CI / NIT:</strong> {{ $datos->dniRemitente }}</p>
            ...
            <hr>
            <h2>CONSIGNATARIO</h2>
            <p><strong>CI / NIT:</strong> {{ $datos->dniReceptor }}</p>
            ...
            <p><strong>Fecha de envio:</strong> {{ $datos->fecha_salida }}</p>
